...
<title>HOME - Creative Agency Template</title>
<meta name=description content="home page dummy description">

@stop
@section('content')	
	<section>
		<div class="header-content-area" style="background-image: url({{ 'img/header.png' }});">
			<div class="container">
				<!--header pattern-->
